...
const mongoURI = `mongodb+srv://preshstoredb:${password}@cluster0.zx10p7z.mongodb.net/e-commerce`;
...
app.get("/popularinwomen", async (req, res) => {
  let products = await Product.find({ category: /Women/i });
  let arr = products.splice(0, 4);
  console.log("Popular In Women");
  res.send(arr);
});

// Create an endpoint for updating product description
